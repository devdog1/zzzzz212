...
if (!function_exists('get_db_connection')) {
    ...
    } elseif (file_exists(__DIR__ . '/zzz5-repo/db.php')) {
        require_once __DIR__ . '/zzz5-repo/db.php';
    }
}
...
} elseif (file_exists(__DIR__ . '/zzz5-repo/functions.php')) {
    require_once __DIR__ . '/zzz5-repo/functions.php';
}

if (file_exists(__DIR__ . '/plugins/incident-management/models/helper_functions.php')) {
    require_once __DIR__ . '/plugins/incident-management/models/helper_functions.php';
}
...
if (!class_exists('PluginDatabase')) {
    ...
    } elseif (file_exists(__DIR__ . '/zzz5-repo/PluginDatabase.php')) {
        require_once __DIR__ . '/zzz5-repo/PluginDatabase.php';
    }
}

if (!class_exists('EventManager')) {
    require_once __DIR__ . '/plugins/incident-management/models/EventManager.php';
    require_once __DIR__ . '/plugins/incident-management/models/OTRSClient.php';
    require_once __DIR__ . '/plugins/incident-management/models/OTRSDB.php';
    require_once __DIR__ . '/plugins/incident-management/models/NetBoxClient.php';
}
